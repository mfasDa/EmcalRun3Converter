...
find_library(AliRoot_LIBRARY_ANALYSIS NAMES ANALYSIS HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)
find_library(AliRoot_LIBRARY_ANALYSISALICE NAMES ANALYSISalice HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)
find_library(AliRoot_LIBRARY_STEER NAMES STEER HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)
find_library(AliRoot_LIBRARY_STEERBASE NAMES STEERBase HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)
find_library(AliRoot_LIBRARY_ESD NAMES ESD HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)
find_library(AliRoot_LIBRARY_AOD NAMES AOD HINTS ${O2_ROOT}/lib ENV LD_LIBRARY_PATH)

set(AliRoot_LIBRARIES ${AliRoot_LIBRARY_ANALYSIS} ${AliRoot_LIBRARY_ANALYSISALICE} ${AliRoot_LIBRARY_STEER} ${AliRoot_LIBRARY_STEERBASE} ${AliRoot_LIBRARY_ESD} ${AliRoot_LIBRARY_AOD})
